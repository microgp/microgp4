...
def test_simple():
    ...
    # VECTOR of Scalars
    assert ugp.fit.UniformVector([23, 2], ugp.fit.Float) == ugp.fit.UniformVector([23, 2], ugp.fit.Float)
    assert not ugp.fit.UniformVector([23, 2], ugp.fit.Float) != ugp.fit.UniformVector([23, 2], ugp.fit.Float)
    assert not ugp.fit.UniformVector([23, 2], ugp.fit.Float) == ugp.fit.UniformVector([23, sqrt(2)**2], ugp.fit.Float)
    assert ugp.fit.UniformVector([23, 2], ugp.fit.Float) != ugp.fit.UniformVector([23, sqrt(2)**2], ugp.fit.Float)
    assert ugp.fit.UniformVector([23, 10], ugp.fit.Float) == ugp.fit.UniformVector([23, 10], ugp.fit.Float)
    assert not ugp.fit.UniformVector([23, 10], ugp.fit.Float) == ugp.fit.UniformVector([10, 23], ugp.fit.Float)
    assert ugp.fit.UniformVector([23, 10], ugp.fit.Float) != ugp.fit.UniformVector([10, 23], ugp.fit.Float)
    assert ugp.fit.UniformVector([23, 10], ugp.fit.Float) > ugp.fit.UniformVector([10, 23], ugp.fit.Float)
    assert ugp.fit.UniformVector([23, 10], ugp.fit.Float) >= ugp.fit.UniformVector([10, 23], ugp.fit.Float)
    assert not ugp.fit.UniformVector([23, 10], ugp.fit.Float) < ugp.fit.UniformVector([10, 23], ugp.fit.Float)
    assert not ugp.fit.UniformVector([23, 10], ugp.fit.Float) <= ugp.fit.UniformVector([10, 23], ugp.fit.Float)
    ...
    # VECTOR of Scalar
    assert ugp.fit.UniformVector([23, 2], ugp.fit.Scalar) == ugp.fit.UniformVector([23, 2], ugp.fit.Scalar)
    assert not ugp.fit.UniformVector([23, 2], ugp.fit.Scalar) != ugp.fit.UniformVector([23, 2], ugp.fit.Scalar)
    assert ugp.fit.UniformVector([23, 2], ugp.fit.Scalar) == ugp.fit.UniformVector([23, sqrt(2)**2], ugp.fit.Scalar)
    assert not ugp.fit.UniformVector([23, 2], ugp.fit.Scalar) != ugp.fit.UniformVector([23, sqrt(2)**2], ugp.fit.Scalar)
    assert not ugp.fit.UniformVector([23, 2], ugp.fit.Scalar) == ugp.fit.UniformVector([sqrt(2)**2, 23], ugp.fit.Scalar)
    assert ugp.fit.UniformVector([23, 2], ugp.fit.Scalar) != ugp.fit.UniformVector([sqrt(2)**2, 23], ugp.fit.Scalar)
    assert ugp.fit.UniformVector([23, 2], ugp.fit.Scalar) > ugp.fit.UniformVector([sqrt(2)**2, 23], ugp.fit.Scalar)
    assert ugp.fit.UniformVector([23, 2], ugp.fit.Scalar) >= ugp.fit.UniformVector([sqrt(2)**2, 23], ugp.fit.Scalar)
    assert not ugp.fit.UniformVector([23, 2], ugp.fit.Scalar) < ugp.fit.UniformVector([sqrt(2)**2, 23], ugp.fit.Scalar)
    assert not ugp.fit.UniformVector([23, 2], ugp.fit.Scalar) <= ugp.fit.UniformVector([sqrt(2)**2, 23], ugp.fit.Scalar)
